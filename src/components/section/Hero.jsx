            ...
            <div className="relative mx-auto flex min-h-screen max-w-[1500px] flex-col px-6 py-6 sm:px-10 lg:px-16">
                ...
                <section className="grid flex-1 items-center gap-16 py-16 lg:grid-cols-[1fr_0.85fr] lg:gap-24 lg:py-20">
                    ...
                    <div className="max-w-2xl">
                        ...
                        <h1 className="text-[clamp(2.5rem,10vw,8rem)] font-black leading-[0.82] tracking-[-0.045em]">
                        ...
                        <p className="mt-10 max-w-lg text-sm leading-7 text-black/55 sm:text-[15px]">
                        ...
                        <div className="mt-16 flex items-center gap-3 font-mono text-[9px] uppercase tracking-[0.15em] text-black/40">
                            <span className="text-[#c8102e]">01</span>
                        ...
                        <div className="relative">
                            ...
                            <div className="px-1 pt-6">
                                <div className="flex items-center justify-between gap-5">
                                    <div className="min-w-0">
                                        ...
                                        <p className="mt-1 flex items-center font-mono text-[9px] text-black/40">
                                            <span>{track.artist}</span>

                                            <span className="mx-2 h-1 w-1 shrink-0 rounded-full bg-[#c8102e]" />
                                    ...
                                    <button
                                        ...
                                        className={`grid h-10 w-10 shrink-0 place-items-center rounded-full transition-all duration-300 ${isPlaying
                                            ...
                                            : "bg-black text-white hover:bg-[#c8102e]"
                                            }`}
                                    >
                                        {isPlaying ? (
                            ...
                            <div className="px-1 pt-6">
                                <div className="relative h-4 w-full">
                                    ...
                                    <div
                                        className="absolute left-0 top-1/2 h-[2px] -translate-y-1/2 bg-[#c8102e]"
                                        style={{
                                            width: `${progress}%`,
                                        }}
                                    />
                                    ...
                                    <div
                                        className="pointer-events-none absolute top-1/2 h-3 w-3 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#c8102e]"
                                        style={{
                                            left: `${progress}%`,
                                        }}
                                    />
                ...
                <footer className="flex items-center justify-between border-t border-black/15 pt-5 font-mono text-[8px] uppercase tracking-[0.12em] text-black/40">
                    <span>Jakarta, Indonesia</span>

                    <span className="hidden text-[#c8102e] sm:block">
                        YG LO REMEHIN LAGI DIATAS PANGGUNG LO TONTONIN
                    </span>
